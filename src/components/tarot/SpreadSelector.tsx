...
export function SpreadSelector() {
  ...
  const handleSelect = (id: string) => {
    ...
    // Add a small delay to allow click animation to complete and prevent white screen issues
    setTimeout(() => {
      selectSpread(id);
  ...
  return (
    <div className="w-full h-full overflow-y-auto">
      <div className="w-full min-h-full max-w-3xl mx-auto px-4 py-12 flex flex-col justify-center">
